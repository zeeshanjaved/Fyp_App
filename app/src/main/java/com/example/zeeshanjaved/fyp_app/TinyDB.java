...
//    public ArrayList<String> getListuserlist(String key ){
//    	Gson gson = new Gson();
//
...
//    		UserInfo value  = gson.fromJson(jObjString, UserInfo.class);
//    		objects.add(value);
//    	}
//    	return objects;
//    }
...
//    }
//
//    public void putListUser(String key, ArrayList<UserInfo> objArray){
//    	checkForNullKey(key);
//    	Gson gson = new Gson();
